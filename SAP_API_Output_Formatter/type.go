...
type Confirmation struct {
			...
			CapacityRequirementSplit       int         `json:"CapacityRequirementSplit"`
			...
			ToMaterialMovements            string      `json:"to_ProdnOrdConfMatlDocItm"`
}
...
type MaterialMovements struct {
			...
			ToBatchCharacteristic      string      `json:"to_ProdnOrderConfBatchCharc"`
}
